{
          ...
          "targets": [
            {
              ...
              "editorMode": "code",
              "expr": "sum (rate (container_cpu_usage_seconds_total{image!=\"\",name=~\".*\",kubernetes_io_hostname=~\"^$Node$\"}[$interval])) by (pod)",
              "format": "time_series",
              "interval": "10s",
              "intervalFactor": 1,
          ...
          "targets": [
            {
              ...
              "editorMode": "code",
              "expr": "sum (rate (container_cpu_usage_seconds_total{pod!=\"\",kubernetes_io_hostname=~\"^$Node$\"}[$interval])) by (container)",
              "format": "time_series",
              "hide": false,
              "interval": "10s",
              "intervalFactor": 1,
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum (container_memory_working_set_bytes{image!=\"\",name=~\".*\",kubernetes_io_hostname=~\"^$Node$\"}) by (pod)",
          "format": "time_series",
          "interval": "10s",
          "intervalFactor": 1,
          "legendFormat": "{{ pod_name }}",
          ...
          "targets": [
            {
              ...
              "editorMode": "code",
              "expr": "sum (container_memory_working_set_bytes{pod!=\"\",kubernetes_io_hostname=~\"^$Node$\"}) by (container)",
              "format": "time_series",
              "interval": "10s",
              "intervalFactor": 1,
              "legendFormat": "{{ container_name }}",
          ...
          "targets": [
            {
              ...
              "editorMode": "code",
              "expr": "sum (rate (container_network_receive_bytes_total{image!=\"\",name=~\"^.*\",kubernetes_io_hostname=~\"^$Node$\"}[$interval])) by (pod)",
              "format": "time_series",
              "interval": "10s",
              "intervalFactor": 1,
              "legendFormat": "-> {{ pod_name }}",
  ...
  "uid": "ac2c6100-10d0-46b0-a97c-f2e2890fae17",
  "version": 7,
  "weekStart": ""
}
